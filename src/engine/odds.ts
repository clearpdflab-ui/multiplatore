...
export const BOOKMAKER_MODELS: Record<'132_300' | '130_315', BookmakerModelConfig> = {
  '132_300': {
    ...
    fairOverProb: 30.56,
    description:
      'Under più alto (1.32) per massimizzare la moltiplicazione della Schedina Madre; Over 3.00 per solida copertura.',
  },
  '130_315': {
    id: '130_315',
    label: '1.30 — 3.15',
    ...
    fairOverProb: 29.21,
    description:
      'Aggio bookmaker più basso (8.67% vs 9.09%). Over 3.15 più generoso, abbassa la puntata di recupero sulle coperture.',
  },
};

export function calculateBookmakerAggio(
  underOdds: number,
  overOdds: number,
): {
  overround: number;
